  ...
  ;(function ($) {
    $.fn.nekoScroll = function (option) {
      var defaultSetting = {
        ...
        right: 55.6 + "px",
        nekoImg:
          "https://img1.baidu.com/it/u=1214308178,97974039&fm=253&fmt=auto&app=138&f=PNG",
        hoverMsg: "啦啦啦~",
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Fomalhaut🥝 %c 你正在访问阿显の小家",
...
function createtime() {
  ...
  ;(currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<span>什么时候能够实现财富自由呀~</span><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> `
      : `<span>下班了就该开开心心地玩耍~</span><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://pic-bed-2tr.pages.dev/computer/PC-4.webp);
    --darkmode-bg:url(https://pic-bed-2tr.pages.dev/computer/PC-5.webp);
    --mobileday-bg: url(https://pic-bed-2tr.pages.dev/phone/phone-1.webp);
    --mobilenight-bg: url(https://pic-bed-2tr.pages.dev/phone/phone-2.webp);
  }`
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pic-bed-2tr.pages.dev/img/shoujiBZ1.webp)" class="pimgbox" onclick="changeBg('url(https://pic-bed-2tr.pages.dev/img/shoujiBZ1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pic-bed-2tr.pages.dev/img/shoujiBZ2.webp)" class="pimgbox" onclick="changeBg('url(https://pic-bed-2tr.pages.dev/img/shoujiBZ2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pic-bed-2tr.pages.dev/img/shoujiBZ3.webp)" class="pimgbox" onclick="changeBg('url(https://pic-bed-2tr.pages.dev/img/shoujiBZ3.webp)')"></a></div>
              </div>
            </details>
